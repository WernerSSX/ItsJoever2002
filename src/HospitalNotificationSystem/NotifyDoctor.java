...
/**
 * @class NotifyDoctor
 * @brief Singleton class for notifying a doctor via Telegram.
 * 
...
public class NotifyDoctor extends HNSTelegramBot {
    ...
    /**
     * @brief Retrieves the singleton instance of the NotifyDoctor class.
     * 
    ...
    /**
     * @brief Sends a notification message to the doctor via Telegram.
     * 
